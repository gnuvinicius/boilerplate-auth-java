...
public class ManagerService implements IManagerService {
  ...
  public List<UsuarioResponseDto> listaTodosUsuarios() {
    ...
    List<Usuario> usuarios = userRepository
        .buscaPorEmpresa(Status.ATIVO, authService.getCompanyByUserLogged());
  ...
  public Empresa cadastra(EmpresaRequestDto dto) throws Exception {
    ...
    try {
      ...
      throw new IllegalArgumentException("Não foi possivel concluir o cadastro da sua empresa: " + ex.getMessage());
    }
  }
